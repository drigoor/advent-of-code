...
// FROM: https://github.com/GustavoHGAraujo/kotlin-a-star-algorithm/tree/master/AlgorithmAStar/src


abstract class AlgorithmAStar<V : Graph.Vertex, E : Graph.Edge<V>>(protected val edges: List<E>) : Graph {
